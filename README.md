Тестовое задание по разработке одной страницы сайта без использования фреймворков и библиотек. Реализована адаптивности, добавлена система сборки Webpack.
